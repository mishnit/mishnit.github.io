...
# Code of Conduct
  ...
  - Reviewer may use an abbreviation in the beginning of comment ([reference](https://web.stanford.edu/~ouster/cgi-bin/cs190-spring15/reviewCodes.php)) 
  - Approval can be mentioned using LGTM i.e. "Looks good to me"  
